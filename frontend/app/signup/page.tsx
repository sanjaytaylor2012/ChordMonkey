      ...
      <>
        ...
        <div className="min-h-screen bg-background relative flex items-center justify-center px-6 py-12">
          ...
          <div className="relative z-10 w-full max-w-md">
            <div className="bg-card border border-border rounded-xl p-8 shadow-sm dark:shadow-none dark:ring-1 dark:ring-white/5 text-center">
          ...
          <div className="bg-card border border-border rounded-xl p-8 shadow-sm dark:shadow-none dark:ring-1 dark:ring-white/5">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Start building chord progressions with Chord Monkey
              </p>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 rounded-lg border border-border bg-background text-foreground font-medium hover:bg-muted transition-colors flex items-center justify-center gap-3"
              >
